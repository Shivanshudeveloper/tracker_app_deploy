  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'invoiceview', element: <InvoiceSample /> },
        { path: 'people', element: <People /> },
        { path: 'detailreport', element: <DetailReport /> },
...
const InvoiceSample = Loadable(lazy(() => import('../pages/dashboard/InvoiceSample')));
const DetailReport = Loadable(lazy(() => import('../pages/dashboard/DetailReport')));
